...
class base64_binary(unittest.TestCase):
	...
	def testEncodeBinary(self):
		...
		base = ft.base64(bin)
		self.assertEquals(self.pythocat, base)

	def testNullString(self):
		a = base64.b64encode("\x00\x00\x00\x00")
		b = ft.base64("\x00\x00\x00\x00")
		self.assertEquals(a, b)

	def testStringWithNulls(self):
		a = base64.b64encode("\x00AB\x00CD\x00\x00")
		b = ft.base64("\x00AB\x00CD\x00\x00")
		self.assertEquals(a, b)
